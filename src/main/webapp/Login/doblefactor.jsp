                ...
                <div class="col-md-6 offset-md-1" style="margin-left: 0px !important;">
                  <div >
                    ...
                    <div class="card-body">
                      ...
                      <form class="form" role="form" autocomplete="off" method="post" action="<%= request.getContextPath()%>/Login?accion=compararCodigo2fa">
                        <div class="form-group">
                          <label for="inputPasswordOld"></label>
                          <input type="text" class="form-control" id="inputPasswordOld" name="codigo2fa" required="" style="margin-top: 7px">
                        </div>
                        ...
                        <div class="form-group text-center" style="margin-top: 20px">
                          <button  type="submit" class="btn btn-primary btn-lg float-right" style="font-size: 18px; border-color: #042354; background-color: #163297; ">Ingresar código</button>
                          <a href="<%=request.getContextPath()%>/Login?accion=2auth" style="font-size: 18px; border-color: red; background-color: red;" class="btn btn-danger btn-lg float-right">Reenviar codigo</a>
                        </div>
                        <div class="form-group">
