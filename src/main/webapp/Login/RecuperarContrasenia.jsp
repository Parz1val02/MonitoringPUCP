...
<%
    ...
    String code = (String) request.getAttribute("codigo");
%>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="container" style="font-family: sans-serif,Montserrat">
            ...
            <div class="row" style="font-size: 17px">
                ...
                <div class="col-md-5" style="margin: 0 auto">
                    ...
                    <div>
                        <i class="material-icons">check</i>
                        <h7>Contiene al menos un carácter dentro de un conjunto de caracteres especiales (@#%$^ etc.)
                        </h7>
                    </div>

                    <div style="height: 40px; display: block;"></div>
                </div>
                <form method="post" action="<%=request.getContextPath()%>/Login?accion=recuperar">
                    <input type="text" class="form-control" name="codigo" value="<%=code%>" hidden>
                    <div class="col-md-5" style="margin: auto; font-size: 18px">
                        ...
                        <div align="center">
                            <a href="<%=request.getContextPath()%>/Login" style="font-size: 15px">Cancelar</a>
                        </div>
                    </div>
                </form>
                <div class="col-md-1"></div>
