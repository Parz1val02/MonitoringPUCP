      ...
      <div class="content-wrapper">
        <div class="container" style="margin-top: 50px">
          ...
          <div class="form-floating" style="margin-bottom: 5px;display: flex; align-items: center">
            <input class="form-control" type="text" placeholder="Nombre" aria-label="Disabled input example" disabled
                   readonly>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item img-container <%if(i==0){%> active <%}%>">
                      <img src="<%=request.getContextPath()%>/AdminServlet?accion=verFoto&id=<%=fotito.getIdFotos()%>"
