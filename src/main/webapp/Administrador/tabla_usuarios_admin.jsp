                ...
                <div class="page-heading" style="  margin-top: 30px;">
                    <div class="row g-2">
                        <div class="col-10" style="">
                            <h1 class="page-title" style="font-size: 40px; font-weight: bold;"><b>Tabla de usuarios</b>
                            </h1>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="example-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%= usuario.getCodigo()%>
                                        </td>
                                        <td><%= usuario.getRol().getNombreRol()%>
                                        </td>
                                        <% if (usuario.getCategoriaPUCP().getNombreCategoria() == null) {%>
                                        <td>No tiene categoría</td>
                                        <%} else { %>
                                        <td><%= usuario.getCategoriaPUCP().getNombreCategoria()%>
                                        </td>
                                        <% }%>
