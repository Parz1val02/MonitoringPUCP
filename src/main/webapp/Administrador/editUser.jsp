              ...
              <div class="ibox-body">
                ...
                <form method="post" action="<%=request.getContextPath()%>/AdminServlet?action=actualizar">
                    ...
                    <div class="col-md">
                      <div class="form-floating" style="margin-bottom: 5px;">
                        <input type="text" class="form-control" id="floatingInputGrid4" placeholder="Correo PUCP"
                               name="correoPUCP" value="<%=usuario.getCorreo()%>">
                    ...
                    <div class="col-md">
                      <div class="form-floating" style="margin-bottom: 5px;">
                        <input type="text"
                               ...
                               id="floatingInputGrid5" placeholder="DNI" name="dni" value="<%=usuario.getDni()%>">
                    ...
                    <div class="col-md">
                      <div class="form-floating" style="margin-bottom: 5px;">
                        <input type="text"
                               ...
                               value="<%=usuario.getCelular()==null?"No phone":usuario.getCelular()%>">
                  ...
                  <div class="row">
                    <div class="col-md">
                      <div class="form-floating">
                        ...
                        <select class="form-select" id="floatingSelectGrid1" name="rol">
                          ...
                          <option value="1" <%=usuario.getRol().getIdRol() == 1 ? "selected" : ""%>>Usuario PUCP
                          </option>
                    ...
                    <div class="col-md">
                      <div class="form-floating">
                        <input type="text" hidden id="floatingInputGrid100"
                               value="<%=usuario.getCategoriaPUCP()==null?"":usuario.getCategoriaPUCP().getNombreCategoria()%>">
