                ...
                <div>
                  ...
                  <div class="card-body">
                    <form method="post" class="form" role="form" autocomplete="off"
                          action="<%=request.getContextPath()%>/SeguridadServlet?accion=cambiarContrasena">
                      <div class="form-group">
                        <label for="inputPasswordOld" style="font-weight: bold; font-size: 17px">Contraseña
                          actual</label>
                        <input type="password" class="form-control" id="inputPasswordOld" style="margin-top: 7px"
                               name="contraseñaActual" required>
                      </div>
                      <div class="form-group">
                        <label for="inputPasswordNew" style="font-weight: bold; padding-top: 18px; font-size: 17px">Nueva
                          contraseña</label>
                        <input type="password" class="form-control" id="inputPasswordNew" style="margin-top: 7px"
                               name="contraseñaNueva" required>

                      </div>
                      <div class="form-group">
                        <label for="inputPasswordNewVerify"
                               style="font-weight: bold; padding-top: 18px; font-size: 17px">Confirmar nueva
                          contraseña</label>
                        <input type="password" class="form-control" id="inputPasswordNewVerify" style="margin-top: 7px"
                      ...
                      <div class="form-group" style="margin-top: 20px">
                        <button type="submit" class="btn btn-primary btn-lg float-right"
                                style="font-size: 18px; border-color: #042354; background-color: #042354; ">Aceptar y
                          Continuar
                        </button>
                      </div>
                    </form>
