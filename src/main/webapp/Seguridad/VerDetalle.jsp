        ...
        <div class="page-wrapper">
            ...
            <div class="content-wrapper">
                <div class="container" style="margin-top: 50px">
                    ...
                    <input class="form-control" type="hidden" placeholder="Nombre" aria-label="Disabled input example"
                           disabled readonly value="<%=incidencia.getZonaPUCP().getLatitud()%>">
                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item img-container <%if(i==0){%> active <%}%>">
                                            <img src="<%=request.getContextPath()%>/SeguridadServlet?accion=verFoto&id=<%=fotito.getIdFotos()%>"
