...
<div class="page-footer" style="color: rgb(255, 255, 255); margin-top: 100px !important; margin-bottom: 0px !important; background-color: rgb(4, 35, 84) !important;">
    <div class="container" style="margin-left: 0px; margin-right: 0px; padding-left: 0px; padding-right: 0px; border-top-style: solid !important; border-top-width: 0px !important; padding-top: 50px !important;">
        <div class="row" style="height: 234px; width: 1120px; margin-right: 0px; margin-left: 50px !important; margin-top: 0px !important;"><div class="column w-col w-col-3" style="width: 518px !important; height: 234px !important;"><h2 class="footer-heading">Ubicación</h2><p class="paragraph">Campus principal<br>Av. Universitaria 1801, San Miguel, 15088<br>Lima, Perú</p><ul role="list" class="list w-list-unstyled"><li><a href="https://www.google.com.pe/maps/place/Pontificia+Universidad+Cat%C3%B3lica+del+Per%C3%BA/@-12.0696448,-77.0794097,17z/data=!4m2!3m1!1s0x9105c96b3c0f27c9:0x3465e7eda67712e9" target="_blank" class="footer-link como">Cómo llegar</a></li><li><a href="https://www.pucp.edu.pe/la-universidad/mapa-del-campus/" class="footer-link">Ver mapa del campus</a></li></ul></div><div class="w-col w-col-4" style="width: 518px !important;"><h2 class="footer-heading">CONTACTO</h2><p class="paragraph">Central telefónica 626-2000<br>Desde provincias 0800-1-7827 (servicio gratuito)</p><div class="w-layout-grid grid-4" style="height: 172px !important;"><a href="https://www.pucp.edu.pe/contacto/?tema=otros" class="footer-linkl w-inline-block"><img src="../images/enviarmensaje.png" style="width: 100px !important; height: 60px !important;"><div class="text-block-5" style="width: 200px !important;">Enviar mensaje</div></a><a href="http://www.pucp.edu.pe/libro-reclamaciones/" target="_blank" class="footer-linkl _2 w-inline-block"><img src="../images/libroabierto.png" style="width: 100px !important; height: 60px !important;"><div class="text-block-5" style="width: 200px !important;">Libro de Reclamaciones</div></a></div></div></div></div>

    <div class="div-block-6" style="margin-left: 50px !important; margin-bottom: 0px !important; height: 120px !important;"><div class="container-bootstrap footer2 w-container" style="margin-bottom: 50px !important;"><div class="text-block-6">© Pontificia Universidad Católica del Perú - Todos los derechos reservados</div><div class="text-block-7">Síguenos en:</div><div class="div-block-8"><a href="https://twitter.com/pucp/"><img src="../images/twitter.png" style="width: 35px !important; margin-right: 10px !important;"></a><a href="https://facebook.com/pucp/"><img src="../images/facebook.png" style="width: 35px !important; border-right-width: 10px !important; margin-right: 10px !important;"></a><a href="https://youtube.com/pucp/"><img src="../images/youtube.png" style="width: 35px !important; border-right-width: 10px !important; height: 35px !important; margin-right: 10px !important;"></a><a href="https://www.instagram.com/pucp/?hl=es-la"><img src="../images/instagram.png" style="width: 35px !important; margin-right: 10px !important;"></a><a href="https://www.tiktok.com/@pucp?lang=es"><img src="../images/tiktok.png" style="width: 35px !important; margin-right: 10px !important;"></a></div></div></div></div>
</body>
</html>
