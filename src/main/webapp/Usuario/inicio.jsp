...
<%
    ArrayList<Incidencia> listaIncidencias = (ArrayList<Incidencia>) request.getAttribute("listaIncidencia");
%>
<!DOCTYPE HTML>
<html lang="en">
        ...
        <div class="boxed-page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-radius: 20px;">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="Buscar_Incidencia.jsp">
                        <!-- this anchor text for link your home to another page -->
                        <div class="icon">
                    ...
                    <a class="navbar-brand" href="registrar.jsp">
                        <!-- this anchor text for link your home to another page -->
                        <div class="icon">
                    ...
                    <a class="navbar-brand" href="misincidencias.jsp">
                        <!-- this anchor text for link your home to another page -->
                        <div class="icon">
                    ...
                    <a class="navbar-brand" href="usuario.jsp">
                        <!-- this anchor text for link your home to another page -->
                        <div class="icon">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-12">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <h6><%= incidencia[1].getNombreIncidencia()%></h6>
                                                </div>
                                                <div class="col-md-3">
                                                    <i class="material-icons">favorite</i>
                                                    <h8>
                                                        <%= incidencia[1].getContadorDestacado()%>
                                                    </h8>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-calendar" src=""></i>
                                                <h8><%= incidencia[1].getFecha()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="fa fa-location-arrow"></i>
                                                <h8><%= incidencia[1].getZonaPUCP()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <h8><%= incidencia[1].getTipoIncidencia()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="material-icons">traffic</i>
                                                <h8><%= incidencia[1].getNivelUrgencia()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-12">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <h6><%= incidencia[2].getNombreIncidencia()%></h6>
                                                </div>
                                                <div class="col-md-3">
                                                    <i class="material-icons">favorite</i>
                                                    <h8>
                                                        <%= incidencia[2].getContadorDestacado()%>
                                                    </h8>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-calendar" src=""></i>
                                                <h8><%= incidencia[2].getFecha()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="fa fa-location-arrow"></i>
                                                <h8><%= incidencia[2].getZonaPUCP()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-ambulance"></i>
                                                <h8><%= incidencia[2].getTipoIncidencia()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="material-icons">traffic</i>
                                                <h8><%= incidencia[2].getNivelUrgencia()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-12">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <h6><%= incidencia[3].getNombreIncidencia()%></h6>
                                                </div>
                                                <div class="col-md-3">
                                                    <i class="material-icons">favorite</i>
                                                    <h8>
                                                        <%= incidencia[3].getContadorDestacado()%>
                                                    </h8>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-calendar" src=""></i>
                                                <h8><%= incidencia[3].getFecha()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="fa fa-location-arrow"></i>
                                                <h8><%= incidencia[3].getZonaPUCP()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-ambulance"></i>
                                                <h8><%= incidencia[3].getTipoIncidencia()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="material-icons">traffic</i>
                                                <h8><%= incidencia[3].getNivelUrgencia()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-12">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <h6><%= incidencia[4].getNombreIncidencia()%></h6>
                                                </div>
                                                <div class="col-md-3">
                                                    <i class="material-icons">favorite</i>
                                                    <h8>
                                                        <%= incidencia[4].getContadorDestacado()%>
                                                    </h8>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-calendar" src=""></i>
                                                <h8><%= incidencia[4].getFecha()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="fa fa-location-arrow"></i>
                                                <h8><%= incidencia[4].getZonaPUCP()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-ambulance"></i>
                                                <h8><%= incidencia[4].getTipoIncidencia()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="material-icons">traffic</i>
                                                <h8><%= incidencia[4].getNivelUrgencia()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-12">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <h6><%= incidencia[5].getNombreIncidencia()%></h6>
                                                </div>
                                                <div class="col-md-3">
                                                    <i class="material-icons">favorite</i>
                                                    <h8>
                                                        <%= incidencia[5].getContadorDestacado()%>
                                                    </h8>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-calendar" src=""></i>
                                                <h8><%= incidencia[5].getFecha()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="fa fa-location-arrow"></i>
                                                <h8><%= incidencia[5].getZonaPUCP()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-ambulance"></i>
                                                <h8><%= incidencia[5].getTipoIncidencia()%></h8>
                                            </div>
                                            <div class="col-md-6">
                                                <i class="material-icons">traffic</i>
                                                <h8><%= incidencia[5].getNivelUrgencia()%></h8>
                                            </div>
                                        </div>
                                    </div>
                                </div>
