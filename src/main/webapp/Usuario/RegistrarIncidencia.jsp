                ...
                <div class="page-content fade-in-up col-md-8" style="align-content: center; margin: auto">
                    <div class="container" style=" height: 100%">
                        <div class="page-heading" style="text-align: center; margin:auto">
                            <h1 class="page-title" style="font-size: 40px; font-weight: bold"><b>Registrar
                                Incidencias</b></h1>
                        </div>
                            ...
                            <div class="ibox-body">
                                ...
                                <form method="post" action="<%=request.getContextPath()%>/UsuarioServlet?accion=guardar"
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating" style="margin-bottom: 15px">
                                                <input type="text"
                                                       class="form-control <%=nombreValido.length()>0?"is-invalid":""%>"
                                                       id="floatingInputGrid2" placeholder="Nombre Incidencia"
                                                       name="nombre_incidencia">
                                                <label for="floatingInputGrid2" class="label-form-flujousuario">Nombre
                                                    Incidencia</label>
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating" style="margin-bottom: 15px">
                                                <input type="date" name="fecha" id="date"
                                                       class="sangria-filter <%=fechaValida2.length()>0?"is-invalid":""%>"
                                                       placeholder="dd-mm-yyyy" max="<%=dateFormat.format(today)%>"
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating" style="margin-bottom: 15px;">
                                                <select class="form-select <%=zonaValida.length()>0?"is-invalid":""%>"
                                                        id="zonaPUCP" name="zonaPUCP">
                                                    <% for (ZonaPUCP zona : zonas) {%>
                                                    <option value="<%=zona.getIdZonaPUCP()%>"><%= zona.getNombreZona()%>
                                                    </option>
                                                    <% }%>
                                                </select>
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating " style="margin-bottom: 15px;">
                                                <select class="form-select <%=tipoValida.length()>0?"is-invalid":""%>"
                                                        id="tipoIncidencia" name="tipoIncidencia">
                                                    <% for (TipoIncidencia tipo : tipos) {%>
                                                    <option value="<%=tipo.getIdTipo()%>"><%= tipo.getTipo()%>
                                                    </option>
                                                    <% }%>
                                                </select>
                                                <label for="tipoIncidencia" class="label-form-flujousuario">Tipo de
                                                    Incidencia</label>
                                            ...
                                            <input type="text"
                                                   class="form-control <%=otroTipoValida.length()>0?"is-invalid":""%>"
                                                   id="Otros" placeholder="Otro tipo" name="Otros" disabled>
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating" style="margin-bottom: 15px;">
                                                <select class="form-select <%=nivelValida.length()>0?"is-invalid":""%>"
                                                        id="floatingSelectGrid1" name="nivelIncidencia">
                                                    <% for (NivelUrgencia nivel : niveles) {%>
                                                    <option value="<%=nivel.getIdNivelUrgencia()%>"><%= nivel.getNivel()%>
                                                    </option>
                                                    <% }%>
                                                </select>
                                                <label for="floatingSelectGrid1" class="label-form-flujousuario">Nivel
                                                    de Urgencia</label>
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-4"
                                             style="display: flex; justify-content: center;  flex-direction: column">
                                            <p class="campos-registrar-usuario">Fotos:</p>
                                        </div>
                                        <div class="col-md">
                                            <div class="form-floating" style="margin-bottom: 15px;">
                                                <input type="file" name="fotoIncidencia" id="file2"
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating" style="margin-bottom: 15px;">
                                                <textarea
                                                        class="form-control <%=descripcionValida.length()>0?"is-invalid":""%>"
                                                        id="floatingInputGrid7" cols="40" rows="5"
                                                        placeholder="Descripcion"
                                                        style="height: 133px; width: 100%;overflow: auto;resize: none"
                                        ...
                                        <div style="color:#FF0000;"><p text-align="center;" style="margin-top: 1px;"
                                                                       class="font-weight-bold">Todos los campos son
                                            obligatorios.</p></div>
                                    ...
                                    <div class="form-group" style="text-align: right">
                                        <button class="btn btn-primary" type="submit"
                                                href="<%=request.getContextPath()%>/UsuarioServlet?accion=listar">
