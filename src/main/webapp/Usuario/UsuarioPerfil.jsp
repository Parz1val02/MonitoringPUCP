                        ...
                        <div class="col-md" align="center">
                            <div class="row g-4">
                                ...
                                <div class="col-md" style="display: flex; justify-content: center;margin-left: 10px">
                                    ...
                                    font-weight: 700; font-size: 18px; color: #042354" >Nickname</p>
                                </div>
                                <div class="col-md">
                                    <label>
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" value="<%=usuario.getNickname()%>" readonly>
                                            </div>
                                        </div>
                                        <a style="font-size: 13px"> (Editar nickname) </a>
                                    </label>
                                </div>
                                <div class="col-md"></div>
                            </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md">
                                    <p class="campos-registrar-usuario" style="font-family: sans-serif,Montserrat;
                                    font-weight: 700; font-size: 17px; color: #042354; margin: 0">Cambiar foto de perfil:</p>
                                    <div style="height: 5px; display: block;"></div>
                                    <div class="" style="margin-bottom: 15px;">
                                        <input style="font-size: 15px" type="file" name="file[]" id="file" accept="image/png, image/gif, image/jpeg" multiple/>
