        ...
        <div class="ibox-body">
          <table class="table table-striped table-bordered table-hover" id="example-table">
            ...
            <tr>
              ...
              <td>
                <a href="<%=request.getContextPath()%>/UsuarioServlet?accion=verDetalle&id=<%=incidencia.getIdIncidencia()%>">Confirmar Atencion</a>
              </td>
      ...
      <div class="modal-body">
        ...
        <div style =  "margin-left: 10px" class="form-floating">
          <p>
            ...
            <label for="floatingTextarea1"></label><textarea class="form-control" placeholder="Detalles de tu incidencia" id="floatingTextarea1" style="height: 100px"></textarea>
          </p>
        </div>
        <br><br>

      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" >Confirmar</button>
