...
public class EnviarCorreoEstadoSeguridad {
    public static void main(String correoDestino, Incidencia inc, int caso, String estado, String justificacion)throws MessagingException {
        ...
        if(caso==1){
            ...
            msg = "La incidencia " + inc.getNombreIncidencia()+" ha cambiado su estado a "+estado+"." +
                    "\n"+
                    "Justificacion del personal de seguridad: "+ justificacion;
        }
