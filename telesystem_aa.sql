...
insert into Incidencias (fecha,nombreIncidencia, validaIncidencia, descripcion,
                         ...
                         values ("2022-12-09","Accidente de tránsito",true,"Camioneta se chocó y derribó un muro",0,null,1,3,1,20201696,12),
                         (curdate(),"Accidente en semana de Ingeniería",true,"Lesión de alumna en evento",0,null,1,2,1,20195922,11),
                         ("2022-12-09","Robo de bicicleta",true,"Se robaron mi bicicleta cerca de generales letras",0,null,2,2,1,20171198,4),
...
insert into RegistroAdmin (nombreAdmin, passwordAdmin, nombreRol, correo, codigo2fa, activeTime2fa) values("EternalBlue", sha2("Cl@shRoy@le123",256), "Administrador", "EternalBlue@pucp.edu.pe", null, null);
